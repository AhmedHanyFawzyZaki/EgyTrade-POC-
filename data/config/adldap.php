            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', '192.168.1.53 corp-dc1.corp.acme.org corp-dc2.corp.acme.org')),
                ...
                */
                ...
                //'base_dn' => env('ADLDAP_BASEDN', 'dc=corp,dc=acme,dc=org,dc=Cairo1,dc=com'),
                'base_dn' => env('ADLDAP_BASEDN', 'dc=Cairo1,dc=com'),
