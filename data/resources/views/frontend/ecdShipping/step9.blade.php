...
<h3 class="alert alert-info text-center">{{trans('declaration.Freight Details')}}</h3>
...
<div class="box">
    ...
    <div class="box-body">
        ...
        echo BootForm::select('fd_shipping_port', ['html' => trans('declaration.Shipping Port') . ' <span class="required">*</span>'], \App\Models\ShippingPorts::pluck('name' . $field_ar, 'id')->prepend(trans('declaration.Please select shipping port'), ''), '', ['class' => 'select2']);
