<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li {{ (( Request::is('declaration/*') || Request::is('declaration')) && !Request::is('declaration/applicationState')) || Request::is('services') ? 'class=active' : '' }}><a href="{{ route('home.services') }}">{{ trans('messages.Provided Services') }}</a></li>
